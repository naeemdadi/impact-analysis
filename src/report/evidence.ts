...
export function buildReportEvidence(analysisInput: DeterministicPrAnalysis, semantic: { featureTargets?: FeatureVerificationTarget[]; changedHunks?: ChangedHunk[] } = {}): ReportEvidence {
  ...
  return {
    version: 2, repoId: analysis.repoId, pullRequestNumber: analysis.pullRequestNumber, baseSha: analysis.baseSha, headSha: analysis.headSha,
