...
import { getPrCommentDelivery, markPrCommentDelivered } from "./pr-comment-delivery-repository.js";
...
export async function deliverPullRequestComment(
  ...
  // This deployment has one embedded delivery worker. The desired
  // analysis/SHA/state conditions below fence stale jobs without session-level
  // PostgreSQL advisory locks, which are unsafe with transaction-pooling
  // proxies such as Supavisor/PgBouncer.
